...
/**
 * Client-side interactive shell for the site layout (header/nav/footer).
 * Data (siteSettings, aboutSections) is fetched server-side by the Layout
 * wrapper and passed in as props, so this component only owns interactivity.
 */

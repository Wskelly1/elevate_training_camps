        ...
        <form className="space-y-6">
          <div className="flex gap-4">
            <div className="flex-1">
              <label className="block font-semibold mb-1 text-black" htmlFor="firstName">First Name</label>
              <Input id="firstName" placeholder="First Name" />
            </div>
            <div className="flex-1">
              <label className="block font-semibold mb-1 text-black" htmlFor="lastName">Last Name</label>
              <Input id="lastName" placeholder="Last Name" />
            </div>
          </div>
          <div>
            <label className="block font-semibold mb-1 text-black" htmlFor="email">Email</label>
            <Input id="email" type="email" placeholder="Email" />
          </div>
          <div>
            <label className="block font-semibold mb-1 text-black" htmlFor="subject">Subject</label>
            <Input id="subject" placeholder="Subject" />
          </div>
          <div>
            <label className="block font-semibold mb-1 text-black" htmlFor="message">Message</label>
            <Textarea id="message" placeholder="Type your message here." rows={4} />
          </div>
          <Button type="submit" className="w-full h-12 text-base font-semibold bg-[#3c6e45] hover:bg-[#4a7f53]">Send Message</Button>
        </form>
      </div>
    </Layout>
  );
